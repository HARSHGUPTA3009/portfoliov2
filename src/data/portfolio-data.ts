...
github: "https://github.com/HARSHGUPTA3009/HOSMASv2",
...
},
{
  ...
  title: "Quyl — AI Study Assistant (Thapar)",

  description:
    "Thapar-specific AI study assistant built using RAG architecture, trained on academic content across 7 engineering branches and 6 semesters. Features conversational document Q&A, intelligent course-aware retrieval, and a centralized file management system.",
  ...
  image: "/projects/quyl.png",

  highlights: [
    "Built under GDG on Campus initiative",
    "Impacted 300+ students across campus",
    "Course-aware Retrieval-Augmented Generation (RAG)",
    "Conversational PDF and document Q&A",
    "Academic content indexed across 7 branches and 6 semesters",
    "Integrated file management and knowledge retrieval system",
    "Context-aware responses grounded in university course material",
    "Production-ready AI assistant for student learning workflows",
  ],
},
];
